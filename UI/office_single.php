                    ...
                    <div class="card padding-card reviews-card property-single-slider">
                        <div class="card-body">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-0">Stave Martin <small>Feb 12, 2018</small>
                                        <span class="star-rating float-right">
                                            ...
                                            <i class="mdi mdi-star-half text-warning"></i><small
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-0">Mark Smith <small>Feb 09, 2018</small> <span
                                    ...
                                    <div class="media mt-4">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mt-0">Ryan Printz <small>Nov 13, 2018</small> <span
                                                    class="star-rating float-right">
                                                    <i class="mdi mdi-star text-warning"></i>
                                                    <i class="mdi mdi-star text-warning"></i>
                                                    <i class="mdi mdi-star-half text-warning"></i>
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="card-body pb-0 about-agent-info">
                                                    ...
                                                    <h6 class="card-subtitle mb-3 text-muted"><i
                                                            class="mdi mdi-phone"></i> (950) 491-570-180</h6>
                                                    <h6 class="card-subtitle mb-3 text-muted"><i
                                                            class="mdi mdi-email"></i> support@example.com</h6>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="card card-list">
                                            <a href="#">
                                                <div class="card-img">
                                                    <div class="badge images-badge"><i class="mdi mdi-image-filter"></i>
                                                        03</div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="card-subtitle mt-1 mb-0 text-muted"><i
                                                            class="mdi mdi-home-map-marker"></i> Hope Street (Stop P),
                                                        London SW11, UK</h6>
                                                </div>
                                                <div class="card-footer">
                                                    ...
                                                    <span><i class="mdi mdi-move-resize-variant"></i> Area : <strong>100
                                                            sq ft</strong></span>
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <div class="card card-list">
                        <a href="#">
                            ...
                            <div class="card-footer">
                                ...
                                <span><i class="mdi mdi-move-resize-variant"></i> Area : <strong>587 sq
                                        ft</strong></span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="card card-list">
                        <a href="#">
                            ...
                            <div class="card-footer">
                                ...
                                <span><i class="mdi mdi-move-resize-variant"></i> Area : <strong>300 sq
                                        ft</strong></span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="card card-list">
                        <a href="#">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title mb-2">Loft Above The City</h5>
                                <h6 class="card-subtitle mt-1 mb-0 text-muted"><i class="mdi mdi-home-map-marker"></i>
                                    Hope Street (Stop P), London SW11, UK</h6>
                            </div>
                            <div class="card-footer">
                                <span><i class="mdi mdi-sofa"></i> Beds : <strong>2</strong></span>
                                <span><i class="mdi mdi-scale-bathroom"></i> Baths : <strong>1</strong></span>
                                <span><i class="mdi mdi-move-resize-variant"></i> Area : <strong>100 sq
                                        ft</strong></span>
                            </div>
                        </a>
                    </div>
